					...
					<table class="table table-striped table-bordered" style="color:black">
						...
						<tbody>
							...
							<c:forEach var="man" items="${manav}">
							 ...
							 <td> <a href=/seePostasUser?pid=${man.postID}>See Post</a></td> 
							</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<table class="table table-striped table-bordered" style="color:black">
						...
						<tbody>
							...
							<c:forEach var="note" items="${NOTE}">
							 ...
							 <td> <a href=/seePostasUser?pid=${note.pid}>See Post</a></td> 
							</tr>
							</c:forEach>
							<c:forEach var="note1" items="${NOTE1}">
								<tr>
								<td><c:out value="${note1.uname}" /> has commented on your post</td>
								
							 <td> <a href=/seePostasUser?pid=${note1.pid}>See Post</a></td> 
							</tr>
							</c:forEach>
						</tbody>
					</table>
...
<c:choose> 
  ...
  <div class="card-header">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="/profile1Admin">Profile</a>
      </li>
      <li class="nav-item">
...
<nav class="navbar navbar-toggleable-md navbar-light bg-success">
		  <a class="navbar-brand" href="#" style="text-align:center">${name}</a>
		</nav>

		<div class="container py-5">
			<div class="row">
				<div class="col-12">
					<img src="${image}" alt="Profile page image" class="rounded-circle" style="border:solid 1px black; width:30px; height:40px;"/>
					<h2 class="py-3" style="border:solid 1px black; border-radius:12px; margin:1% 20% 4% 20%;">${dis} </h2>
